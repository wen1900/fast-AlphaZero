...
cdef class Board():
    ...
    def __init__(self, int n):
        ...
        '''
        '''
        #Set up the initial for 4 center Othello
        #left top
        self.pieces[self.n//4-1,self.n//4] = -1
        self.pieces[self.n//4,self.n//4-1] = -1
        self.pieces[self.n//4-1,self.n//4-1] = 1
        self.pieces[self.n//4,self.n//4] = 1


        #right top
        self.pieces[self.n//4-1,self.n//4*3] = -1
        self.pieces[self.n//4,self.n//4*3-1] = -1
        self.pieces[self.n//4-1,self.n//4*3-1] = 1
        self.pieces[self.n//4,self.n//4*3] = 1

        #left bottom
        self.pieces[self.n//4*3-1,self.n//4] = -1
        self.pieces[self.n//4*3,self.n//4-1] = -1
        self.pieces[self.n//4*3-1,self.n//4-1] = 1
        self.pieces[self.n//4*3,self.n//4] = 1

        #right bottom
        self.pieces[self.n//4*3-1,self.n//4*3] = -1
        self.pieces[self.n//4*3,self.n//4*3-1] = -1
        self.pieces[self.n//4*3-1,self.n//4*3-1] = 1
        self.pieces[self.n//4*3,self.n//4*3] = 1
        '''
        #Set up the initial for 4 center Othello
        #left top
        self.pieces[self.n//4-1,self.n//4] = 1
